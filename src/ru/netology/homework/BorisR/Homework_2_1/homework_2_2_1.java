...
import static ru.netology.homework.BorisR.Homework_2_1.homework_2_2_1_Matrix.*;

public class homework_2_2_1 {

//    public static int matrixSize = 8; // Размер матрицы
//    public static int[][] matrix = new int[matrixSize][matrixSize]; // Мааисв для первоначальной матрицы
